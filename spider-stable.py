...
class SpiderGUI(object):
        ...
        for instance in self.session.query(User).filter_by(key='0'):
            if self.run:
                ...
                try:
					...
					print 'Sender function crashed, try again, maby ...'
					sys.exit(1)
    ...
    def set_timeout(self):
        print 'Setting timeout to magic random random choice ...'
        ...
        for x in range(self.sawe_search,page+1):
            if self._run:
                ...
                try:
					...
					print 'Search function crashed, try again NEWER!!! ...'
					sys.exit(1)
